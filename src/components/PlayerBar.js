     ...
     return (
       <section className="player-bar">
         ...
         <section id="volume-control">
           ...
           />
             <div className="icon ion-md-volume-low" onClick ={ this.props.handleVolumeDownClick}></div>
             <div className="icon ion-md-volume-high" onClick ={ this.props.handleVolumeUpClick}></div>
         </section>
       </section>
     );
   }
